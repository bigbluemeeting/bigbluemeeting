            ...
            <div class="modal-body">
                <div class="card-body p-sm-6">
                    ...
                    <div class="input-icon mb-2">
                        ...
                        <input id="edit-meeting-name" class="form-control text-center"  placeholder="Enter a Meeting name..." autocomplete="off" type="text" name="name">
                    ...
                    <div class="row mt-2">
                        <div class="col-md-12">
                            ...
                            <textarea class="form-control welcome_message" name="welcome_message"  placeholder="A welcome message shown in the chat meeting" id="" cols="40" rows="1.5"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="mt-3 ml-3">
                            <input type="submit" name="commit" value="Update Meeting" class="update-only btn btn-info btn-block" data-disable-with="Update Meeting" >
                        </div>
                    </div>
